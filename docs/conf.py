# -*- coding: utf-8 -*-
#
# pytest-ipython_shell documentation build configuration file, created by
...
project = u'pytest-ipython_shell'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-ipython_shell Documentation',
     [author], 1)
]
